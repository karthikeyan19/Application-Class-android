...
public class Q1 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizHeaderTextView.setText(getResources().getText(R.string.head_quiz).toString().replace('?', '1'));
        ...
        questionTextView.setText(quizApplication.getQuestion(0));

        final String[] options = quizApplication.getOption(0).split(",");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    quizApplication.updateAnswer(0, index);
