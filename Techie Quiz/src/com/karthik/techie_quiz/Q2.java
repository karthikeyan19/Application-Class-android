 ...
 */
public class Q2 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizHeaderTextView.setText(getResources().getText(R.string.head_quiz).toString().replace('?', '2'));
        ...
        questionTextView.setText(quizApplication.getQuestion(1));

        final String[] options = quizApplication.getOption(1).split(",");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    quizApplication.updateAnswer(1, index);
