...
public class Q5 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizHeaderTextView.setText(getResources().getText(R.string.head_quiz).toString().replace('?', '5'));
        ...
        questionTextView.setText(quizApplication.getQuestion(4));

        final String[] options = quizApplication.getOption(4).split(",");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    quizApplication.updateAnswer(4, index);
