...
public class Q4 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizHeaderTextView.setText(getResources().getText(R.string.head_quiz).toString().replace('?', '4'));
        ...
        questionTextView.setText(quizApplication.getQuestion(3));

        final String[] options = quizApplication.getOption(3).split(",");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    quizApplication.updateAnswer(3, index);
